...
subprocess.run("hadoop fs -put /mnt/c/Users/Miles/Documents/GitHub/futurense_hadoop-pyspark/labs/dataset/bankmarket/bankmarketdata.csv /user/training/bankmarketing/raw".split())
...
try :
	...
	bank_df.write.mode('overwrite').parquet('hdfs://localhost:9000/user/training/bankmarketing/staging/')
